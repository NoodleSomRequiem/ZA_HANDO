...
const addE = document.querySelector("#E")
const classify = document.querySelector("#classify")

addO.addEventListener("click",() =>learnO() && console.log ("learning O"))
addL.addEventListener("click",() =>learnL() && console.log ("learning L"))
addE.addEventListener("click",() =>learnE() && console.log ("learning E"))
...
// training - todo: meerdere voorbeelden voor cats en dogs nodig!
    ...
    function learnO(){
        ...
        log.innerText = (`adding O`)
    }
    function learnL(){
        machine.learn(webcamdata,'L')
        console.log (`adding L`)
        log.innerText = (`adding L`)
    }
    function learnE(){
        machine.learn(webcamdata,'E')
        console.log (`adding E`)
        log.innerText = (`adding E`)
